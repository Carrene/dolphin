...
from dolphin.models import Project, Member, Workflow, Group, Release, Specialty, \
    Phase, Issue, Item, IssuePhase
from .helpers import LocalApplicationTestCase, oauth_mockup_server
from dolphin.constants import ITEM_RESPONSE_TIME
...
class TestItem(LocalApplicationTestCase):
    ...
    def mockup(cls):
        ...
        with Context(dict()):
            ...
            cls.item = Item(
                ...
                member=cls.member1,
                need_estimate_timestamp=datetime.now() - timedelta(days=10),
            )
    ...
    def test_extend(self):
        ...
        with oauth_mockup_server(), self.given(
            ...
            assert response.json['responseTime'] == ITEM_RESPONSE_TIME - 1
